                            ...
                            <CardActions className={classes.cardActions}>
                                <Box className={classes.author}>
                                    ...
                                    <Typography variant="subtitle1" component="p">
                                            <br></br>The GST will be registered within 1 working day after it is shared to the professional(which will be notified) along with your application number.
                                        </Typography>
                                    </Box>
                                </Box>
                            </CardActions>
