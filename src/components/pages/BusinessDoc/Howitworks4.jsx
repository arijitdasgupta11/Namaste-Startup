                            ...
                            <CardActions className={classes.cardActions}>
                                <Box className={classes.author}>
                                    ...
                                    <Typography variant="subtitle1" component="p">
                                            <br></br>The IEC will be registered within 3 working day after it is shared to the professional(which will be notified by your dedicated expert) with application number.
                                        </Typography>
                                    </Box>
                                </Box>
                            </CardActions>
                            ...
                            <CardActions className={classes.cardActions}>
                                <Box className={classes.author}>
                                    ...
                                    <Box ml={2}>
                                        ...
                                        <Typography variant="subtitle1" component="p">
                                            <br></br>Final IEC registration document will be delivered to you to your e-mail address by the dedicated expert. You can contact him/her for any clarifications.
                                        </Typography>
                                    </Box>
                                </Box>
                            </CardActions>
