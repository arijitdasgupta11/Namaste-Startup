                            ...
                            <CardActions className={classes.cardActions}>
                                <Box className={classes.author}>
                                    ...
                                    <Typography variant="subtitle1" component="p">
                                            <br></br>The legal document will be drafted within 3 working days after it is shared to the professional lawyer (which will be notifiedby your dedicated expert).
                                        </Typography>
                                    </Box>
                                </Box>
                            </CardActions>
                            ...
                            <CardActions className={classes.cardActions}>
                                <Box className={classes.author}>
                                    ...
                                    <Box ml={2}>
                                        ...
                                        <Typography variant="subtitle1" component="p">
                                            <br></br>Final legal document will be deliveredand if there is any rectification that you want to make then 2 days time will be given after delivery.
                                        </Typography>
                                    </Box>
                                </Box>
                            </CardActions>
