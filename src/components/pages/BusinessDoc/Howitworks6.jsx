                            ...
                            <CardActions className={classes.cardActions}>
                                <Box className={classes.author}>
                                    ...
                                    <Typography variant="subtitle1" component="p">
                                            <br></br>The Shop Act will be registered within 1 working day after it is shared to the professional(which will be notified by dedicated expert).
                                        </Typography>
                                    </Box>
                                </Box>
                            </CardActions>
                            ...
                            <CardActions className={classes.cardActions}>
                                <Box className={classes.author}>
                                    ...
                                    <Box ml={2}>
                                        ...
                                        <Typography variant="subtitle1" component="p">
                                            <br></br>Final Shop Act registration document will be delivered to you to your e-mail address by the dedicated expert. You can contact him/her for any clarifications.
                                        </Typography>
                                    </Box>
                                </Box>
                            </CardActions>
